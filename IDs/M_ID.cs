namespace MysteriousKnives.IDs
{
    internal static class MKItemID
    {
        ...
        public static int MK03 = ModContent.ItemType<MK03>();
        public static int MK04 = ModContent.ItemType<MK04>();
        public static int MK05 = ModContent.ItemType<MK05>();
        public static int MK06 = ModContent.ItemType<MK06>();
        public static int MK07 = ModContent.ItemType<MK07>();
    ...
    internal static class MKDustID
    {
        ...
        public static int CBDust = ModContent.DustType<CBDust>();
        public static int RBDust = ModContent.DustType<RBDust>();
        public static int STDust = ModContent.DustType<STDust>();
        public static int SKDust = ModContent.DustType<SKDust>();
    ...
    {
        public static int PotionStation = ModContent.TileType<MKPotionStation_Tile>();
    }
} 
